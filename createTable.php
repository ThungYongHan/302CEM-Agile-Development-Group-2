...
((SELECT user_id FROM Users WHERE username ='user2'), (SELECT game_id FROM Games WHERE game_name ='Genshin Impact'), 'If you are looking for a fun game that you can just sit back and relax with, then Genshin Impact is excellent for that. The game’s world is pleasant to drink in and the combat is a nice balance of being involved, while not becoming overly complicated.', 4, '1000-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user3'), (SELECT game_id FROM Games WHERE game_name ='Genshin Impact'), 'If you are looking for a fun game that you can just sit back and relax with, then Genshin Impact is excellent for that. The game’s world is pleasant to drink in and the combat is a nice balance of being involved, while not becoming overly complicated.', 3, '1000-01-01 00:00:00'),

((SELECT user_id FROM Users WHERE username ='user1'), (SELECT game_id FROM Games WHERE game_name ='League of Legends'), 'League of Legends is a fantastic game with something for players of all skill ranges to enjoy. Although it is better to play with friends, you are not left to your own devices if you tend to keep to yourself. ', 5, '2021-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user2'), (SELECT game_id FROM Games WHERE game_name ='League of Legends'), 'League of Legends is a fairly well polished game in that it optimizes team game play and coordination.', 4, '2021-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user3'), (SELECT game_id FROM Games WHERE game_name ='League of Legends'), 'The only saving grace of this game is that it is free to play. Besides that there is nothing positive to say about this game. Riot does nothing about the toxicity of player base.', 1, '2021-01-01 00:00:00'),

((SELECT user_id FROM Users WHERE username ='user1'), (SELECT game_id FROM Games WHERE game_name ='Fast & Furious Crossroads'), 'Fast and Furious Crossroads is a disappointing game from an experienced studio like Slightly Mad. Low production values, an absurd driving model and a very short story make it very hard to suggest anyone playing it.', 1, '1000-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user2'), (SELECT game_id FROM Games WHERE game_name ='Fast & Furious Crossroads'), 'League of Legends is a fantastic game with something for players of all skill ranges to enjoy. Although it is better to play with friends, you are not left to your own devices if you tend to keep to yourself. The early hours can be frustrating as you learn the ropes, but once you are swept away by the ebb and flow, it is difficult to resist the constant thrill of the diverse battles.', 1, '1000-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user3'), (SELECT game_id FROM Games WHERE game_name ='Fast & Furious Crossroads'), 'League of Legends is a fantastic game with something for players of all skill ranges to enjoy. Although it is better to play with friends, you are not left to your own devices if you tend to keep to yourself. The early hours can be frustrating as you learn the ropes, but once you are swept away by the ebb and flow, it is difficult to resist the constant thrill of the diverse battles.', 1, '1000-01-01 00:00:00'),

((SELECT user_id FROM Users WHERE username ='user1'), (SELECT game_id FROM Games WHERE game_name ='Minecraft'), 'Minecraft is possibly one of the best video games I have ever played, it challenges you to build, craft and fight after you become stranded on an almost infinite terrain named by you.', 1, '1000-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user2'), (SELECT game_id FROM Games WHERE game_name ='Minecraft'), 'League of Legends is a fantastic game with something for players of all skill ranges to enjoy. Although it is better to play with friends, you are not left to your own devices if you tend to keep to yourself. The early hours can be frustrating as you learn the ropes, but once you are swept away by the ebb and flow, it is difficult to resist the constant thrill of the diverse battles.', 1, '1000-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user3'), (SELECT game_id FROM Games WHERE game_name ='Minecraft'), 'League of Legends is a fantastic game with something for players of all skill ranges to enjoy. Although it is better to play with friends, you are not left to your own devices if you tend to keep to yourself. The early hours can be frustrating as you learn the ropes, but once you are swept away by the ebb and flow, it is difficult to resist the constant thrill of the diverse battles.', 1, '1000-01-01 00:00:00'),

((SELECT user_id FROM Users WHERE username ='user1'), (SELECT game_id FROM Games WHERE game_name ='Dawn of Fear'), 'Dawn of Fear tries to bring back the nostalgia of classic survival horror but fails in almost every way. The poor controls lead to most of its problems and a lack of necessary mechanics creates problems that should not  exist in this day and age from the simplest of games.', 1, '2021-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user2'), (SELECT game_id FROM Games WHERE game_name ='Dawn of Fear'), 'Dawn of Fear is a poor attempt to recreate the magic of a survival horror classic, with too many problems to gain any sense of enjoyment. Brok3nsite has tried to create a nostalgic tribute to Resident Evil, but in the process they have somehow made it worse than the original.', 1, '2021-01-01 00:00:00'),
((SELECT user_id FROM Users WHERE username ='user3'), (SELECT game_id FROM Games WHERE game_name ='Dawn of Fear'), 'League of Legends is a fantastic game with something for players of all skill ranges to enjoy. Although it is better to play with friends, you are not left to your own devices if you tend to keep to yourself. The early hours can be frustrating as you learn the ropes, but once you are swept away by the ebb and flow, it is difficult to resist the constant thrill of the diverse battles.', 1, '1000-01-01 00:00:00')";
