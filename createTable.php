...
((SELECT user_id FROM Users WHERE username ='user1'), 'Genshin Impact', 'Genshin Impact is an open-world action role-playing game that allows the player to control one of four characters in a party. Switching between characters can be done quickly during combat, allowing the player to use different combinations of skills.', 'miHoYo', '2021-09-01 09:00:00', '2017', LOAD_FILE('C:/xampp1/htdocs/302CEM-Agile-Development-Group-2-master/images/Genshin_cover.jpg')),
((SELECT user_id FROM Users WHERE username='user2'), 'League of Legends','League of Legends features a team-based competitive game mode based on strategy and outplaying opponents. Players work with their team to break the enemy Nexus before the enemy team breaks theirs.','Riot Games', '2021-08-01 08:00:00', '2009', LOAD_FILE('C:/xampp1/htdocs/302CEM-Agile-Development-Group-2-master/images/League_cover.jpg')),
((SELECT user_id FROM Users WHERE username='user3'), 'Fast & Furious Crossroads', 'Fast & Furious Crossroads is a racing and action role-playing video game based on the Fast & Furious film franchise.  Gear up for an epic new chapter in the Fast & Furious saga with high-speed heists, cinematic nonstop action, and adrenaline-fueled stunts.','Bandai Namco', '2021-07-01 07:00:00', '2020', LOAD_FILE('C:/xampp1/htdocs/302CEM-Agile-Development-Group-2-master/images/Furious_cover.jpg')),
((SELECT user_id FROM Users WHERE username='user1'), 'Minecraft', 'Explore infinite worlds and build everything from the simplest of homes to the grandest of castles in Minecraft. Play in creative mode with unlimited resources or mine deep into the world in survival mode, crafting weapons to fend off mobs.','Mojang Studios', '2021-06-01 06:00:00', '2011', LOAD_FILE('C:/xampp1/htdocs/302CEM-Agile-Development-Group-2-master/images/Minecraft_cover.jpeg')),
((SELECT user_id FROM Users WHERE username='user2'), 'Dawn of Fear', 'Dawn of Fear is a survival horror with 3rd person camera that tells the story of Alex, a young man with a past marked by tragedy. The player will have to solve puzzles, collect clues and objects, and survive.','Brok3nsite', '2021-05-01 05:00:00', '2020', LOAD_FILE('C:/xampp1/htdocs/302CEM-Agile-Development-Group-2-master/images/Dawn_cover.jpg'))";
