...
((SELECT user_id FROM Users WHERE username='user1'), 'Minecraft', 'Explore infinite worlds and build everything from the simplest of homes to the grandest of castles in Minecraft. Play in creative mode with unlimited resources or mine deep into the world in survival mode, crafting weapons to fend off mobs.','Mojang Studios', '2021-06-01 06:00:00', '2011', LOAD_FILE('C:/xampp1/htdocs/302CEM/assets/images/Minecraft_cover.png')),
