<?php
    if (isset($_GET['logout'])) {
        ...
        header('Location: http://localhost/damn/302CEM-Agile-Development-Group-2-master/GameBrowsingHomepage.php');
    }
?>
...
function LogoutFunction() {
    ...
    <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #c0d3fc;">
        <div class="container">
          <a href="GameBrowsingHomepage_Admin.php" a class="navbar-brand text-dark">Game Review Website</a>
